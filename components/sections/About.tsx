...
export default function About() {
    ...
    return (
        <section id="about" className="py-10 px-5">
            <div className="relative min-h-[80vh] min-w-[90vw] mx-auto rounded-[2rem] md:rounded-[3rem] overflow-hidden flex items-center bg-cover bg-center" style={{ backgroundImage: "url('/images/gradients/gradient1.webp')" }}>
